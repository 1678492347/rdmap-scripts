...
cluster_frame = pd.read_csv('./origin_data/disorder_gene_18cluster.csv', header=None, index_col=None)
...
distance_frame = pd.read_csv('origin_data/disorder_gene_distance.csv', header=0, index_col=0)
